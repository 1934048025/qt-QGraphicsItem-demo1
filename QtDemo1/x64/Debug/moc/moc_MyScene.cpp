...
QT_MOC_LITERAL(1, 8, 14), // "newItemAchieve"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 14) // "QGraphicsItem*"

    },
    "MyScene\0newItemAchieve\0\0QGraphicsItem*"
};
...
void MyScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newItemAchieve((*reinterpret_cast< QGraphicsItem*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (MyScene::*)(QGraphicsItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyScene::newItemAchieve)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyScene::newItemAchieve(QGraphicsItem * _t1)
{
